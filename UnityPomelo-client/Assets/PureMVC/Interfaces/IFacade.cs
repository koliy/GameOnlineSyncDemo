...
namespace PureMVC.Interfaces
{
    ...
    public interface IFacade : INotifier, IDisposable
    {
        ...
        /// <para>Use this method only if you are sending custom Notifications. Otherwise use the sendNotification method which does not require you to create the Notification instance.</para>
        /// </summary>
